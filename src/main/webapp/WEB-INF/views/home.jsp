<spring:url
	value="/webResources/images/banner_images/banner_21_08_2015_07_09_13.jpg"
	var="imgBanner1" />
	...
	<div class="wrapper products-btm">
		...
		<div class="categories">
			...
			<div class="test-monial-left mt10">
				...
				allmedsdeal. Thanks so much!<br> <br> <strong>Tracy
					Markley</strong>
						...
						<div class="product_area">
							...
							<div class="pro-w">
								...
								<div class="pro-img">
									...
									<figure>
										<a href="zithromax-azithromycin-Azee-1000-mg.html"><img
											src="${contextRoot}/webResources/images/products/product_31221012_azee_1000mg.jpg"
											width="234" height="157" alt=""></a>
									</figure>
								...
								<div class="pro-cnt">
									...
									<p class="fs15 blue">
										<a href="zithromax-azithromycin-Azee-1000-mg.html"
											title="Azee 1000mg">Azee 1000mg</a>
									</p>

									<p class="fs12 weight300 gray3 lht-16 pt8 h30">

										Manufactured by: cipla<br> US Brand: Zithromax

									</p>

									<p class="weight700">Azithromycin</p>

									<p class="weight700 green fs15 mt5">6 PILLs - $10.70</p>

									<p class="btn1 mt15">
										<a href="zithromax-azithromycin-Azee-1000-mg.html">View
											details</a>
									</p>
	...
	<div class="welcomes">
		...
		<div class="wrapper">
			...
			<div class="ac mt30 pl15 pr15">
				...
				AllMedsDeal.com is deeply committed towards the community. <br /> <br />
				AllMedsDeal.com is one of those <b>best online chemists</b> whose
				motto is to simplify your search for medicines and generic drugs
				online. You can either search by Brand-Name or generic name when you
				decide on buying medicine online.
			</div>
		...
		<div class="wrapper newsletter">
			...
			<p class="subscribe show-hide">
				<a href="javascript:void(0)">Subscribe Newsletter <img
					src="${contextRoot}/webResources/images/newsletter-icon.png" alt=""
					title="" class="vam"></a>
			</p>
